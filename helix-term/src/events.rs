...
use helix_view::events::{
    AcpStateChanged, ConfigDidChange, DiagnosticsDidChange, DocumentDidChange, DocumentDidClose,
    DocumentDidOpen, DocumentFocusLost, LanguageServerExited, LanguageServerInitialized,
    SelectionDidChange,
};
...
pub fn register() {
    ...
    register_event::<AcpStateChanged>();
}
